...
const ProductSentScreen: React.FC = () => {
  ...
  const handleVolverInicio = () => {
    ...
    router.push('/(drawer)/HomeScreen'); // O '/(drawer)/ListPrepareScreen'
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Image
            source={require('../../assets/empty_box.png')} // Usamos empty_box.png como icono de enviado, puedes cambiarlo

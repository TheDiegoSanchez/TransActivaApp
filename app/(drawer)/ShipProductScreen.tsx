...
const ShipProductScreen: React.FC = () => {
  ...
  const handleEmbarcar = () => {
    ...
    router.push({
      pathname: '/(drawer)/CarrierInfoScreen',
      params: {
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <TouchableOpacity style={styles.avisarButton} onPress={handleAvisarLlegado}>
            <Text style={styles.buttonText}>Avisar que ha llegado</Text>
          </TouchableOpacity>

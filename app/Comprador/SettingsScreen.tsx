...
// ... (BottomBarIconProps y BottomBarIcon componentes permanecen igual) ...
...
const SettingsScreen: React.FC = () => {
  ...
  // Función para retroceder a HomeScreen
  const goBackToHome = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        {/* Header personalizado CON BOTÓN DE RETROCESO waaa */}
...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    marginLeft: -24 / 2, // Ajuste para centrar el logo y texto TransActiva
  },
  logoImage: {
    width: 30,
    height: 30,

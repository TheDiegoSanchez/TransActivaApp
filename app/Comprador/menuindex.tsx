      ...
      <View style={styles.container}>
        ...
        <View style={styles.plusWrapper}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/Comprador/realizar-pedido')}
          >
        ...
        <View style={styles.bottomBar}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/Comprador/pedidos-realizados')} // <- Modificado aquí
          >
            <Image
              source={require('../../assets/images/caja.png')}
          ...
          <TouchableOpacity
            style={styles.navItem}
            onPress={() => router.push('/Comprador/pedidos-preparados')}
          >
            <Image
